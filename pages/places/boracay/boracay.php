    ...
    <div class="row">
        <div class="col-8" >
            ...
            <div class="hero-image">
                <div class="ism-slider" data-play_type="loop" data-interval="5000" data-image_fx="zoompan" id="my-slider">
                    <ol>
                        <li>
    ...
    <div class="row">
        <div class="col-4">
            <article>
                ...
                <p>
                    The Regency Hotel, Resorts & Spa is a five-star resort with lots of amenities, the rooms are spacious
                    located in the famous White Beach in the center of Station 2. It has excellent gym facilities and all
